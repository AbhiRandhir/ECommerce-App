...
export class CheckoutPaymentComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    this.stripe = Stripe('pk_test_51JMGjkSFfBWLZS7p4M7ujmRGpcDzJLRcMNsHKYRZxef0pg4k26zCVVILvsBVYDm4KFkPmhgpAudaU2emVSeLSXRM00LuFz74tf');
  ...
  private async confirmPaymentWithStrip(basket) {
